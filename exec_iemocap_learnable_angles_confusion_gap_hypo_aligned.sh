...
do
  echo "mode=sdt_cse_learnable_angles_confusion_gap_hypo_aligned seed=${seed}"
  python -u "${SCRIPT_DIR}/train.py" \
    ...
    --hypo-loss-weight 0.02 \
    --hypo-compactness-weight 1 \
    --hypo-alignment-weight 0.1 \
    --hypo-temperature 0.2 \
    --hypo-prototype-momentum 0.9 \
    --hypo-warmup-epochs 10 \
    --hypo-ramp-epochs 20 \
